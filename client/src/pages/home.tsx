...
export default function Home() {
  ...
  const testimonials = [
    ...
    {
      quote: "Luke is an exceptional coach. He has a deep knowledge of business and psychology that equips him to coach on a range of issues.",
      name: "Ross Davies",
  ...
  return (
    <>
      ...
      <section className="min-h-[60vh] md:min-h-[65vh] flex flex-col" style={{
        ...
        {/* Logo Scroller at bottom of viewport - with increased spacing */}
        <div className="w-full pt-12 md:pt-20" style={{ paddingBottom: '20px' }}>
          <LogoScroller />
        </div>
      </section>
