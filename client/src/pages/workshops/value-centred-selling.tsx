        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:border-[#0081ea] transition-colors mb-8">
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                <h4 className="font-bold text-[#0081ea] mb-2">1.  WINNING MINDSET</h4>
              ...
              <div>
                <h4 className="font-bold text-[#0081ea] mb-2">2.  CONTACT ENERGY</h4>
              ...
              <div>
                <h4 className="font-bold text-[#0081ea] mb-2">3.  DOLLAR PRODUCTIVE BEHAVIOURS</h4>
