        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:border-[#dc0725] transition-colors">
              <h4 className="font-bold text-[#dc0725] mb-4 text-xl text-center">Winning Mindset</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:border-[#dc0725] transition-colors">
              <h4 className="font-bold text-[#dc0725] mb-4 text-xl text-center">Contact Energy</h4>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:border-[#dc0725] transition-colors">
              <h4 className="font-bold text-[#dc0725] mb-4 text-xl text-center">Dollar Productive Behaviours</h4>
              <p className="text-gray-700 leading-relaxed">
